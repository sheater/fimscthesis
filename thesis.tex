...
\input{tables/theta-diff-ks-test}
\input{tables/theta-diff-lilliefors-test}
\input{tables/theta-diff-shapiro-wilk-test}
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=8cm]{images/inc-model-graphviz.png}
  \end{center}
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=10cm]{images/theta-posterior-1.png}
  \end{center}
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=11cm]{images/risk-model-fake-rt.png}
  \end{center}
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=11cm]{images/risk-model-fake-sir.png}
  \end{center}
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=11cm]{images/risk-model-fake-incidence.png}
  \end{center}
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=11cm]{images/risk-model-incidence-posterior-predictive.png}
  \end{center}
...
\input{tables/adf-test-brno}
\input{tables/adf-test-ostrava}

\begin{figure}[h]
  \begin{center}
    \includegraphics[width=\textwidth]{images/dev-incidence-1.png}
  \end{center}
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=\textwidth]{images/dev-incidence-2.png}
  \end{center}
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=\textwidth]{images/dev-incidence-3.png}
  \end{center}
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=\textwidth]{images/theta-posterior-2.png}
  \end{center}
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=\textwidth]{images/theta-posterior-3.png}
  \end{center}
